...
# File details
DirName = '../output/mini_millenn_AGNefficiency/'
...
# --------------------------------------------------------
    ...
    yval = np.log(10.) * phistar * xval ** (alpha+1) * np.exp(-xval)
    if(whichimf == 0):
        plt.plot(np.log10(10.0**M *1.6), yval, linestyle=':', color='orchid', lw=10, alpha=0.5, label='... z=[1.3,2.0]')
    elif(whichimf == 1):
        plt.plot(np.log10(10.0**M *1.6/1.8), yval, linestyle=':', color='orchid', lw=10, alpha=0.5, label='... z=[1.3,2.0]')
    ...
    yval = np.log(10.) * phistar * xval ** (alpha+1) * np.exp(-xval)
    if(whichimf == 0):
        plt.plot(np.log10(10.0**M *1.6), yval, linestyle=':', color='pink', lw=10, alpha=0.5, label='... z=[3.0,4.0]')
    elif(whichimf == 1):
        plt.plot(np.log10(10.0**M *1.6/1.8), yval, linestyle=':', color='pink', lw=10, alpha=0.5, label='... z=[3.0,4.0]')
...
# -------------------------------------------------------
    ...
    plt.errorbar(ObsRedshift, ObsSFR, yerr=[yErrLo, yErrHi], xerr=[xErrLo, xErrHi], color='pink', lw=1.0, alpha=0.5, marker='o', ls='none', label='Observations')
    ...
    plt.plot(z[nonzero], np.log10(SFR_density[nonzero]), color='orchid', lw=3.0)
